...
void shortenstring(char** buffer, char* DataBuffer){
	...
	*buffer[1] = '1';
	if(DataBuffer[5] == 0 && DataBuffer[6] == 0 && DataBuffer[7] == 1 && DataBuffer[8] == 0 && DataBuffer[9] == 0) 
	*buffer[1] = '2';// '2'
	...
	*buffer[1] = 'd';// 'd'
	if(DataBuffer[5] == 1 && DataBuffer[6] == 0 && DataBuffer[7] == 0 && DataBuffer[8] == 0 && DataBuffer[9] == 0)
	*buffer[1] = 'e';// 'e'
	...
	*buffer[2] = 'f'; // on
	if(DataBuffer[10] == 1 && DataBuffer[11] == 0 && DataBuffer[12] == 0 && DataBuffer[13] == 1 && DataBuffer[14] == 1) 
	*buffer[2] = '0';// off
	if(DataBuffer[15] == 1 && DataBuffer[16] == 0 && DataBuffer[17] == 1 && DataBuffer[18] == 0 && DataBuffer[19] == 0)
	*buffer[3] = '\r';// '\r'
	*buffer[4] = '\0';
}
